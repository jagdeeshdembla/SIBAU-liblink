...
{
    public partial class Return_bks_fac_Control : UserControl
    {
        public Return_bks_fac_Control()
        {
            InitializeComponent();
        ...
        private void DGV_rbk_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
