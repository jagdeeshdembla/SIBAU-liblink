...
{
    partial class About_fac_Control
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(About_fac_Control));
            label3 = new Label();
            label2 = new Label();
            label1 = new Label();
            SuspendLayout();
            ...
            label3.Location = new Point(8, 314);
            label3.Name = "label3";
            ...
            label2.Location = new Point(8, 172);
            label2.Name = "label2";
            ...
            Controls.Add(label2);
            Controls.Add(label1);
            Name = "About_fac_Control";
            Size = new Size(884, 516);
            Load += About_fac_Control_Load;
            ResumeLayout(false);
            PerformLayout();
        }
